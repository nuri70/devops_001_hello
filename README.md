...
domatesi doğra
Docker Görüntüsü
============= Kendi projemizi Docker imajı haline getirmek =============
Maven
Versiyon 1
...
============= kendi projemizi Docker image'den konteyner haline getirmek =============
docker  run  -it  -d   -p  9091:8080     --name my-app1     nuri01/devops_001_hello:v001
http://localhost:9091

docker  run  -it  -d   -p  9092:8080     --name my-app2     nuri01/devops_001_hello:v002
http://localhost:9092

docker  run  -it  -d   -p  9093:8080     --name my-app3     nuri01/devops_001_hello:v003
http://localhost:9093

============= Docker Hub'a imaj bağlanır =============
